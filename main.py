...
def generateStatusFromDebt(debt_obj):
	...
	# APR
	string_builder.append("📈 ");
	string_builder.append(stripTrailingZerosFromDecimal(str(principal_interest_rate)));
	string_builder.append("% interest (");
	string_builder.append(stripTrailingZerosFromDecimal(str(apr_interest_rate)));
